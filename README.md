# Audix Clone
Audix clone is the clone of Audix website music player in which you can play songs in it. It has the volume bar and song timeline to control the song. It is a functional design of Audix.
<hr>

## Working Web App can be found here

https://Audix-clone-webb.vercel.app/
...
```bash
  git clone https://github.com/Chirag047/Audix-Clone.git
```
